...
import com.example.musfiqrahman.watercount.sync.JobScheduleService;
...
public class MainActivity extends AppCompatActivity implements
    ...
    private final int JOB_INFO_ID = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JobInfo jobInfo = new JobInfo.Builder(JOB_INFO_ID,new ComponentName(getApplicationContext(),JobScheduleService.class))
