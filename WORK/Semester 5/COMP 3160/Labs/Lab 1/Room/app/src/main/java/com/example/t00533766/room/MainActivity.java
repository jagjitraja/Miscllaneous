...
import com.example.t00533766.room.GuestListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guestInfoArrayList = (ArrayList<GuestInfo>) databaseController.selectGuestInfos();
    ...
    public void addToWaitlist(View view) {
        ...
        if(view.getId()==R.id.add_to_waitlist_button) {
            ...
            databaseController.inserGuestInfo(info);
