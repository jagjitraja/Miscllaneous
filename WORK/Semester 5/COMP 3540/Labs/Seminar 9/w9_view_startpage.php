            ...
            <?php
                ...
                if (isset($_COOKIE['username'])) {
                    echo "document.getElementById('welcome-message').innerHTML = 'Welcome back, " . 
                        $_COOKIE['username'] . "!';";
                    echo "document.getElementById('welcome-message').display = ???;";
...
<body>
    ...
    <h2 id='welcome-message' style='text-align:center; display:none'>Welcome message is here.</h2>
    <hr>
    ...
    <div id='signin' class='modal-window'>
        ...
        <br>
        <form method='post' action='w9_controller.php'>
