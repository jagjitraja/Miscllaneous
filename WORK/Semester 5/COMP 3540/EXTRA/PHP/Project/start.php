...
<div id ="box-signin">
    ...
    <form  method = 'post'  action = 'controller.php'  autocomplete='on'>
        ...
        <input type = 'hidden' name = 'cmd' value = 'signin' required>
...
<div id = "box-join">
    ...
    <form  method = 'post' action ='controller.php' autocomplete='on'>
    <input type='hidden' name='page' value='start' required>
    <input type='hidden' name='cmd' value='join' required>
    <p>Username: <input type = 'text' name = 'username' placeholder = 'Enter Username' id='text' required></p>
...
<div id = "box-forgot">
    ...
    <form  method = 'post'  action = 'controller.php' autocomplete = 'on'>
    <input type='hidden' name='page' value='start' required>
    <input type='hidden' name='cmd' value='forgotpassword' required>
    <p>Username: <input type = 'text' name = 'username' placeholder = 'Enter Username' id='text' required></p>
